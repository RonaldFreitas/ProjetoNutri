    ...
    return(
        ...
        <div style={{display: "flex; justify-content: space-around; flex-wrap: wrap"}}>
            ...
            <div className="quadradinho">
                <img src={vidaSaudavelImg} alt="Vida Saudável" />
                <h3>Vida Saudável</h3>
            ...
            <div className="quadradinho">
            <img src={nossosPrincipiosImg} alt="Nossos principios" />
            ...
            <div className="quadradinho">
            <img src={agriculturaEcologicaImg} alt="Agricultura Ecologica" />
            ...
            <div className="quadradinho">
                <img src={boaComidaImg} alt="Boa Comida" />
                <h3>Boa Comida</h3>
